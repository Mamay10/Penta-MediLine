...
const App = () => {
  ...
  return (
    ...
    <div className="h-screen bg-gray-100 flex flex-col p-4 overflow-hidden">
      ...
      <div className="bg-[#1D4A50] w-full h-full rounded-lg shadow-xl p-4 grid grid-cols-1 lg:grid-cols-3 gap-4 overflow-hidden">
        ...
        <div className="bg-white rounded-lg shadow-lg p-4 flex flex-col">
          ...
          <div className="flex flex-col space-y-4 mt-4 overflow-y-auto max-h-[30%]">
              ...
              <table className="w-full text-xs">
                <tbody>
                  {[
                    ...
                    { id: "A03", name: "NABILA", date: "11/09 - 09:12" },
                  ].map((row, index) => (
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 flex flex-col">
          ...
          <div className="bg-[#D9D9D9] text-center text-black font- rounded-t-lg p-3">
            NOMOR ANTRIAN
          </div>
          {/* Informasi nomor antrian aktif */}
          <div className="flex flex-col items-center text-black mt-4 flex-1">
        ...
        <div className="bg-white rounded-lg shadow-lg p-4 flex flex-col">
          ...
          <div className="flex justify-between items-center bg-[#D9D9D9] text-black font-medium rounded-t-lg p-3">
            <span>DATA PASIEN</span> {/* Judul */}
            <span className="text-xs">POLI UMUM   08:00 - 14:00</span> {/* Jadwal poli */}
          </div>
          {/* Informasi pasien */}
