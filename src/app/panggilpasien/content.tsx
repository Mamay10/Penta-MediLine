...
const App = () => {
  ...
  return (
    ...
    <div className="h-50 bg-gray-200 flex flex-col p-4 overflow-hidden">
      ...
      <div className="bg-[#1D4A50] w-full h-full rounded-lg p-4 grid grid-cols-1 lg:grid-cols-3 gap-4 overflow-hidden">
        ...
        <div className="bg-[#1D4A50] rounded-lg shadow-2xl p-4 flex flex-col">
          ...
          <div className="bg-white flex flex-col space-y-2 mt- overflow-y-auto max-h-[50%] p-2">
            ...
            {/* Garis pemisah antara "Dipanggil" dan "Menunggu" */}
        ...
        <div className="h-64 bg-[#1D4A50] rounded-lg shadow-2xl pb-6 flex flex-col mt-4">
        ...
        <div className="bg-[#1D4A50] rounded-lg shadow-2xl p-4 flex flex-col">
          ...
          <div className="bg-[#1D4A50] text-white p-4 rounded-md mt-4 flex-1">
            {[ 
              { label: "Jenis", placeholder: "Masukkan jenis pasien" },
